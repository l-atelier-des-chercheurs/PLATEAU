          ...
          >
            ...
            >
              <div class="_scrollBox">
                ...
                <div class="margin-bottom-small">
                  ...
                  >
                    <input
                      ...
                      :id="res.name"
                      :value="res"
                      v-model="ideal_camera_resolution"
                    />
                    <label :for="res.name">
                      <span>{{ res.name }}</span>
                    </label>
                ...
                <div class="margin-bottom-small">
                  <div>
                    <label>Accès à distance (experimental)</label>
                  </div>
...
import StopmotionPanel from "./subcomponents/StopmotionPanel.vue";
...
export default {
  ...
  created() {
    ...
    navigator.mediaDevices.enumerateDevices().then((deviceInfos) => {
      ...
      Object.keys(this.selected_devicesId).map((kind) => {
        ...
        if (this.sorted_available_devices.hasOwnProperty(kind)) {
          ...
          if (matching_id.length > 0) {
            ...
            this.selected_devicesId[kind] = this.sorted_available_devices[
              kind
            ][0].deviceId;
          }
        }
      ...
      // RESOLUTION
      if (
        this.$root.settings.capture_options.ideal_camera_resolution.width !== ""
      ) {
...
.m_capture {
  ...
  .m_capture--modeSelector {
    ...
    .m_activitiesPanel--do:not(.is--large) & {
  ...
  .m_panel--previewCard {
    ...
    .m_panel--previewCard--live {
      ...
      .m_panel--previewCard--live--stopmotionlist {
        ...
        // border-bottom: 2px solid #2c75c5;
        border-left: 2px solid #2c75c5;

        font-size: 50%;

        // .custom_scrollbar(8px, 5px, 6px, transparent, #2c75c5);
      ...
      .m_panel--previewCard--live--onionskin {
        position: absolute;
        top: 0;
        left: 0;
        right: 0;
    ...
    .m_panel--previewCard--captureOverlay {
      position: absolute;
      left: 0;
      top: 0;
      right: 0;
  ...
  .m_panel--buttons {
    ...
    .m_panel--buttons--row {
      ...
      .m_panel--buttons--row--captureButton {
        ...
        .m_panel--buttons--row--captureButton--btn {
        ...
        .m_panel--buttons--row--captureButton--advancedOptions {
          color: #fff;
          background-color: #f9ca00;
          width: 24px;
          height: 24px;
